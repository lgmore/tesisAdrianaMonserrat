...
\label{sec:intro}
%necesitamos citaciones sobre las distorsiones, algunos paper que hablen por lo menos brevemente del problema%
...
%más o menos la mitad de las citaciones de los artículos van en la introducción, entonces se debe agregar más acá%

%acá falta la parte que dice: en la sección 2 se analiza tal cosa, en la sección 3 se ve tal cosa, etc etc. Es super importante que agreguen todas las secciones que va a tener el paper, y después desarrollar, para que tengan una hoja de ruta%
